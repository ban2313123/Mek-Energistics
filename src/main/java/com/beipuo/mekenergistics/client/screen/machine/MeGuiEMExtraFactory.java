...
public class MeGuiEMExtraFactory extends MeGuiConfigurableTile<TileEntityEMExtraFactory<?>, MekanismTileContainer<TileEntityEMExtraFactory<?>>> {
    @Nullable
    private GuiDumpButton<?> dumpButton;

    public MeGuiEMExtraFactory(MekanismTileContainer<TileEntityEMExtraFactory<?>> container, Inventory inv, Component title) {
