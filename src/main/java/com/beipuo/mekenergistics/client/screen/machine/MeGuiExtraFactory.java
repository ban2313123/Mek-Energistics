...
public class MeGuiExtraFactory extends MeGuiConfigurableTile<TileEntityExtraFactory<?>, MekanismTileContainer<TileEntityExtraFactory<?>>> {

    @Nullable
    private GuiDumpButton<?> dumpButton;

    public MeGuiExtraFactory(MekanismTileContainer<TileEntityExtraFactory<?>> container, Inventory inv, Component title) {
