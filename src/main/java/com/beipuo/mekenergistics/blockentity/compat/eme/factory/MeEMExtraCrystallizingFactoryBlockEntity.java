...
import io.github.masyumero.emextras.common.integration.mekaf.tile.factory.TileEntityEMExtraCrystallizingFactory;
...
public class MeEMExtraCrystallizingFactoryBlockEntity extends TileEntityEMExtraCrystallizingFactory implements MeEvolvedMekanismExtrasFactoryAeMachine {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeEMExtraCrystallizingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
    ...
    @Override public CachedRecipe<ChemicalCrystallizerRecipe> createNewCachedRecipe(ChemicalCrystallizerRecipe recipe, int cacheIndex) { return MeFactoryAeSupport.withAeRecipeEnergy(this, this.energyContainer, super.createNewCachedRecipe(recipe, cacheIndex)); }
    @Override protected boolean onUpdateServer() { boolean changed = super.onUpdateServer(); return getAeSupport().processChemicalSmartPatterns(this.inputChemicalTanks, this.outputItemSlots, List.of()) || changed; }
