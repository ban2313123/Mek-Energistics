...
public class MeExtraStampingFactoryBlockEntity extends TileEntityExtraStampingFactory implements MeFactoryIoOwner {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeExtraStampingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
