...
import io.github.masyumero.emextras.common.integration.mekmm.tile.factory.TileEntityEMExtraStampingFactory;
...
public class MeEMExtraStampingFactoryBlockEntity extends TileEntityEMExtraStampingFactory
        implements MeEvolvedMekanismExtrasFactoryAeMachine {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeEMExtraStampingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
    ...
    @Override public boolean isPatternBusy() { return getExtraSlot() == null || getExtraSlot().isEmpty(); }
