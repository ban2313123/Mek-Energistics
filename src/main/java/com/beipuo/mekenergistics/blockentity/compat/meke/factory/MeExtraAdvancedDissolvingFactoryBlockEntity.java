...
public class MeExtraAdvancedDissolvingFactoryBlockEntity extends TileEntityExtraDissolvingFactory implements MeExtraFactoryBridge.Owner {
    ...
    @Override protected boolean onUpdateServer() { boolean sendUpdatePacket = MeExtraFactoryBridge.processItemChemicalSmartPatterns(this, this.chemicalTank, this.outputChemicalTanks); sendUpdatePacket |= super.onUpdateServer(); return MeExtraFactoryBridge.updateServer(this, sendUpdatePacket, this.outputChemicalTanks, () -> MeExtraFactoryBridge.finishItemChemicalSmartPatterns(this, this.chemicalTank, this.outputChemicalTanks)); }
