...
import io.github.masyumero.emextras.common.integration.mekmm.tile.factory.TileEntityEMExtraRecyclingFactory;
...
public class MeEMExtraRecyclingFactoryBlockEntity extends TileEntityEMExtraRecyclingFactory
        implements MeEvolvedMekanismExtrasFactoryAeMachine {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeEMExtraRecyclingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
