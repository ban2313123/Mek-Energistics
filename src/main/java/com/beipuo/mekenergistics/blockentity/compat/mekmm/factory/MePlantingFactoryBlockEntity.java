...
public class MePlantingFactoryBlockEntity extends TileEntityPlantingFactory implements MeMoreMachineFactoryAeMachine, MeFactoryIoOwner {
    ...
    @Override public MeInputLayout getPatternInputLayout() { return MeInputLayout.unordered(List.of(MeMachineIoAdapter.autoSortedFactoryItemInput(this.inputSlots), MeMachineIoAdapter.chemicalInput(getChemicalTank()), MeMachineIoAdapter.itemInput(getExtraSlot()))); }
