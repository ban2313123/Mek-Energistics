...
public class MeEMExtraWashingFactoryBlockEntity extends TileEntityEMExtraWashingFactory implements MeEvolvedMekanismExtrasFactoryAeMachine {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeEMExtraWashingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
    ...
    @Override public CachedRecipe<FluidChemicalToChemicalRecipe> createNewCachedRecipe(FluidChemicalToChemicalRecipe recipe, int cacheIndex) { return MeFactoryAeSupport.withAeRecipeEnergy(this, this.energyContainer, super.createNewCachedRecipe(recipe, cacheIndex)); }
    @Override protected boolean onUpdateServer() { boolean changed = super.onUpdateServer(); return getAeSupport().processFluidChemicalSmartPatterns(this.fluidTank, this.inputChemicalTanks, List.of(), this.outputChemicalTanks) || changed; }
