...
public class MeExtraAdvancedItemToChemicalFactoryBlockEntity extends TileEntityExtraItemStackToChemicalStackFactory implements MeExtraFactoryBridge.Owner {
    ...
    @Override protected boolean onUpdateServer() { boolean sendUpdatePacket = getAeSupport().processSingleItemSmartPatterns(List.of(), this.inputItemSlots); sendUpdatePacket |= super.onUpdateServer(); return getAeSupport().processSingleItemSmartPatterns(List.of(), this.inputItemSlots) || sendUpdatePacket; }
