...
import com.jerry.mekextras.common.integration.mekaf.tile.factory.TileEntityExtraItemStackToChemicalStackFactory;
...
public class MeExtraAdvancedItemToChemicalFactoryBlockEntity extends TileEntityExtraItemStackToChemicalStackFactory implements MeExtraFactoryBridge.Owner {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeExtraAdvancedItemToChemicalFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
    ...
    @Override protected boolean onUpdateServer() { boolean sendUpdatePacket = MeExtraFactoryBridge.processSingleItemSmartPatterns(this, this.outputChemicalTanks); sendUpdatePacket |= super.onUpdateServer(); return MeExtraFactoryBridge.updateServer(this, sendUpdatePacket, this.outputChemicalTanks, () -> MeExtraFactoryBridge.finishSingleItemSmartPatterns(this, this.outputChemicalTanks)); }
