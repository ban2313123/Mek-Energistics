...
public class MeExtraAdvancedItemToChemicalFactoryBlockEntity extends TileEntityExtraItemStackToChemicalStackFactory implements MeFactoryIoOwner {
    ...
    @Override protected boolean onUpdateServer() { boolean sendUpdatePacket = super.onUpdateServer(); sendUpdatePacket |= getAeSupport().processSingleItemSmartPatterns(List.of(), this.outputChemicalTanks, this.inputItemSlots); return sendUpdatePacket; }
