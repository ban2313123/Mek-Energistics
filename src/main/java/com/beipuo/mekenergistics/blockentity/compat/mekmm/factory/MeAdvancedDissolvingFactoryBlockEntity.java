...
public class MeAdvancedDissolvingFactoryBlockEntity extends TileEntityDissolvingFactory implements com.beipuo.mekenergistics.blockentity.api.MeFactoryIoOwner {
    ...
    @Override public MeInputLayout getPatternInputLayout() { return MeInputLayout.unordered(List.of(MeMachineIoAdapter.autoSortedFactoryItemInput(this.inputItemSlots), MeMachineIoAdapter.chemicalInput(this.chemicalTank), MeMachineIoAdapter.itemInput(getExtraSlot()))); }
