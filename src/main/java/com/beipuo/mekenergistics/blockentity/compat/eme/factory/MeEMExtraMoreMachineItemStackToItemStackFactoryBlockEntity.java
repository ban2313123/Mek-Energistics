...
import io.github.masyumero.emextras.common.integration.mekmm.tile.factory.TileEntityEMExtraItemStackToItemStackMoreMachineFactory;
...
public class MeEMExtraMoreMachineItemStackToItemStackFactoryBlockEntity
        extends TileEntityEMExtraItemStackToItemStackMoreMachineFactory
        implements MeEvolvedMekanismExtrasFactoryAeMachine {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeEMExtraMoreMachineItemStackToItemStackFactoryBlockEntity(
            MeMekanismMachine machine, BlockPos pos, BlockState state) {
