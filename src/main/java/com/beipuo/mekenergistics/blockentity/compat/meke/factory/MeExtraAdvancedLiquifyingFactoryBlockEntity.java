...
public class MeExtraAdvancedLiquifyingFactoryBlockEntity extends TileEntityExtraLiquifyingFactory implements MeFactoryIoOwner {
    private final MeMekanismMachine machine;
    private MeFactoryAeSupport aeSupport;

    public MeExtraAdvancedLiquifyingFactoryBlockEntity(MeMekanismMachine machine, BlockPos pos, BlockState state) {
