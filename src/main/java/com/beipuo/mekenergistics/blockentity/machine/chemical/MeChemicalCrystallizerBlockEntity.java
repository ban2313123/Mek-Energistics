...
public class MeChemicalCrystallizerBlockEntity extends TileEntityChemicalCrystallizer implements ICraftingProvider, MeSmartCableConnection, IActionHost, MeAeMachine {
    private MeRecipeMachineAeSupport<MeChemicalCrystallizerBlockEntity> aeSupport;

    @Override
    public MeRecipeMachineAeSupport<MeChemicalCrystallizerBlockEntity> getRecipeAeSupport() {
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener, IContentsListener recipeCacheListener, IContentsListener recipeCacheUnpauseListener) {
        ...
        var energy = new MeRecipeMachineAeSupport.AeBackedEnergyContainer<TileEntityChemicalCrystallizer>(this, getRecipeAeSupport(), recipeCacheUnpauseListener);
        ((TileEntityChemicalCrystallizerAccessor) this).mekenergistics$setEnergyContainer(energy);
    ...
    @NotNull
    @Override
    public mekanism.api.recipes.cache.CachedRecipe<mekanism.api.recipes.ChemicalCrystallizerRecipe> createNewCachedRecipe(
            @NotNull mekanism.api.recipes.ChemicalCrystallizerRecipe recipe, int cacheIndex) {
