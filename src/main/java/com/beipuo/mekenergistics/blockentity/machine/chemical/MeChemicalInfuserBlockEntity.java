...
public class MeChemicalInfuserBlockEntity extends TileEntityChemicalInfuser implements ICraftingProvider, MeSmartCableConnection, IActionHost, MeAeMachine {
    private MeRecipeMachineAeSupport<MeChemicalInfuserBlockEntity> aeSupport;

    @Override
    public MeRecipeMachineAeSupport<MeChemicalInfuserBlockEntity> getRecipeAeSupport() {
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener, IContentsListener recipeCacheListener, IContentsListener recipeCacheUnpauseListener) {
        ...
        var energy = new MeRecipeMachineAeSupport.AeBackedEnergyContainer<TileEntityChemicalInfuser>(this, getRecipeAeSupport(), recipeCacheUnpauseListener);
