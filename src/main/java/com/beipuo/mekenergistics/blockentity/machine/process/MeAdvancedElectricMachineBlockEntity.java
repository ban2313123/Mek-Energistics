...
public class MeAdvancedElectricMachineBlockEntity extends TileEntityAdvancedElectricMachine
    ...
    private MeRecipeMachineAeSupport<MeAdvancedElectricMachineBlockEntity> aeSupport;
    ...
    @Override
    public MeRecipeMachineAeSupport<MeAdvancedElectricMachineBlockEntity> getRecipeAeSupport() {
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener, IContentsListener recipeCacheListener,
        ...
        var energy = new MeRecipeMachineAeSupport.AeBackedEnergyContainer<TileEntityAdvancedElectricMachine>(this, getRecipeAeSupport(), recipeCacheUnpauseListener);
