...
import com.beipuo.mekenergistics.mixin.TileEntityIsotopicCentrifugeAccessor;
...
public class MeIsotopicCentrifugeBlockEntity extends TileEntityIsotopicCentrifuge implements ICraftingProvider, MeSmartCableConnection, IActionHost, MeAeMachine {
    private MeRecipeMachineAeSupport<MeIsotopicCentrifugeBlockEntity> aeSupport;

    @Override
    public MeRecipeMachineAeSupport<MeIsotopicCentrifugeBlockEntity> getRecipeAeSupport() {
    ...
    protected IEnergyContainerHolder getInitialEnergyContainers(IContentsListener listener, IContentsListener recipeCacheListener, IContentsListener recipeCacheUnpauseListener) {
        ...
        var energy = new MeRecipeMachineAeSupport.AeBackedEnergyContainer<TileEntityIsotopicCentrifuge>(this, getRecipeAeSupport(), recipeCacheUnpauseListener);
        ((TileEntityIsotopicCentrifugeAccessor) this).mekenergistics$setEnergyContainer(energy);
