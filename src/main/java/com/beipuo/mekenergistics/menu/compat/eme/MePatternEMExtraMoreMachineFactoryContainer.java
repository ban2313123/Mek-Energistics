...
public class MePatternEMExtraMoreMachineFactoryContainer extends EMExtraMoreMachineFactoryContainer implements MePatternQuickMoveContainer {
    public MePatternEMExtraMoreMachineFactoryContainer(int id, Inventory inv, TileEntityEMExtraMoreMachineFactory<?> tile) {
        super(id, inv, tile);
    }
